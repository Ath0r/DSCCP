...
parser.add_argument(
    "--volume_path",
    type=str,
    default="/home/yukunkang/DSConv-Net/nets/BRAUnet/BRAU-Netplusplus/synapse_train_test/Synapse",
    help="root dir for validation volume data",
)  # for acdc volume_path=root_dir
parser.add_argument("--dataset", type=str, default="Synapse", help="experiment_name")
parser.add_argument("--num_classes", type=int, default=9, help="output channel of network")
parser.add_argument("--list_dir", type=str, default="./lists/lists_Synapse", help="list dir")
parser.add_argument("--output_dir", type=str, default="./save_models_DLK", help="output dir")
...
if __name__ == "__main__":
    ...
    if not os.path.exists(snapshot):
        snapshot = snapshot.replace("best_model", "synapse_epoch_399")
